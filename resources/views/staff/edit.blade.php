    ...
    <div class="row">
        ...
        <div class="col-lg-6 mx-auto">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form class="supplier" action="{{ route('staffs.update', $staff->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="form-group row">
                            <div class="col-sm-12 mb-3 mb-sm-0">
                                <input type="text" class="form-control text-dark" id="name" name="name" value="{{ old('name') ?? ($staff->user->name ?? '') }}"
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12 mb-3 mb-sm-0">
                                <input type="text" class="form-control text-dark" id="email" name="email" value="{{ old('email') ?? ($staff->user->email ?? '') }}"
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12 mb-3 mb-sm-0">
                                <input type="text" class="form-control text-dark" id="position" name="position" value="{{ old('position') ?? ($staff->position ?? '') }}"
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12 mb-3 mb-sm-0">
                                <input type="text" class="form-control text-dark" id="phone_number" name="phone_number" value="{{ old('phone_number') ?? ($staff->phone_number ?? '') }}"
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12 mb-3 mb-sm-0">
                                <input type="number" class="form-control text-dark" id="salary" name="salary" value="{{ old('salary') ?? ($staff->salary ?? '') }}"
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12 mb-3 mb-sm-0">
                                ...
                                required autocomplete="off" placeholder="Address">{{ old('address') ?? ($staff->address ?? '') }}</textarea>
