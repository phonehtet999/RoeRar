                                    ...
                                    <div id="{{ $value->id }}">
                                        <div class="row mb-4 d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="col-md-1 text-center">
                                                <h6 class="text-primary" id="qty-{{ $value->id }}" data-value="{{ $value->quantity }}" data-unit-price="{{ $value->unit_price }}">{{ $value->quantity }}</h6>
                                            </div>
                            ...
                            <div class="col-lg-4 bg-primary text-light">
                                <div class="p-5">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <h5 id="total-amount">{{ $sale->total_amount }} MMK</h5>
                                    </div>
                                    <hr>
