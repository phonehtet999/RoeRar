    ...
    <div class="row">
        ...
        <div class="col-lg-6 mx-auto">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form class="product" action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div id="thumbnail-div">
                                <a target="_blank" href="#">
                                    <img src="" id="thumbnail" alt="product image" class="image-border-thumbnail col-sm-6 d-block mb-1">
                                </a>
                            </div>
    
                            <div>
                                <div class="custom-file">
                                    <input type="file" name="image" class="custom-file-input" id="image" accept="image/*,.png,.jpg,.gif" required>
                            ...
                            <div class="col-sm-12 mb-3 mb-sm-0">
                                <select name="category_id" class="form-control" id="category-id" required>
                                    ...
                                    @foreach ($categories as $value)
                                        <option value="{{ $value->id }}" {{ old('category_id') ? 'selected' : '' }}>{{ $value->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-sm-12 mb-3 mb-sm-0">
                                <select name="brand_id" class="form-control" id="category-id" required>
                                    ...
                                    @foreach ($brands as $value)
                                        <option value="{{ $value->id }}" {{ old('brand_id') ? 'selected' : '' }}>{{ $value->name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12 mb-3 mb-sm-0">
                                <input type="number" class="form-control text-dark" id="minimum_required_quantity" name="minimum_required_quantity" value="{{ old('minimum_required_quantity') ?? '' }}"
                        ...
                        <div class="form-group row">
                            <div class="col-sm-2 mb-3 mb-sm-0">
                                <input type="color" class="form-control form-control-color" id="color" name="color" value="#ff0000" title="Choose your color" required>
                            </div>
