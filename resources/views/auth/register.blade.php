    ...
    <div class="container m-auto">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block" style="background: url({{ asset('images/icon/roe-rar-icon.jpg') }});background-size: cover;background-position: center"></div>
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="{{ route('store') }}" method="POST">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="name" name="name" value="{{ old('name') ?? '' }}"
